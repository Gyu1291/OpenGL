...
#include "../../../External Libs/GLM/glm/glm.hpp"
#include "../../../External Libs/GLM/glm/gtc/matrix_transform.hpp"
#include "../../../External Libs/GLM/glm/gtc/type_ptr.hpp"
#include <iostream>
#include "../../../utils/shader2.h"
#include <cmath>
...
extern "C" void EMSCRIPTEN_KEEPALIVE glGenVertexArrays();
extern "C" void EMSCRIPTEN_KEEPALIVE glGenBuffers();
extern "C" void EMSCRIPTEN_KEEPALIVE glBindVertexArray();
extern "C" void EMSCRIPTEN_KEEPALIVE glBindBuffer();
extern "C" void EMSCRIPTEN_KEEPALIVE glBufferData();
extern "C" void EMSCRIPTEN_KEEPALIVE glVertexAttribPointer();
extern "C" void EMSCRIPTEN_KEEPALIVE glEnableVertexAttribArray();
extern "C" void EMSCRIPTEN_KEEPALIVE glDeleteVertexArrays();
extern "C" void EMSCRIPTEN_KEEPALIVE glDeleteBuffers();
extern "C" void EMSCRIPTEN_KEEPALIVE glGenVertexArrays();
