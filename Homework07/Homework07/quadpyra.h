...
public:
    ...
    GLfloat quadTexCoords[36] = { // 48 elements
        0.504f, 0.122f,   0.359f, 0.375f,   0.654f, 0.375f,              // v0,v1,v2,v3 (front)
        0.909f, 0.520f,   0.654f, 0.375f,   0.654f, 0.667f,             // v0,v3,v4,v5 (right)
        0.504f, 0.921f,   0.654f, 0.667f,   0.359f, 0.667f,              // v0,v5,v6,v1 (top)
        0.104f, 0.520f,   0.359f, 0.667f,   0.359f, 0.375f,                // v1,v6,v7,v2 (left)
        0.359f, 0.375f,   0.654f, 0.375f,   0.359f, 0.667f,             // v7,v4,v3,v2 (bottom)
        0.654f, 0.375f,   0.359f, 0.667f,   0.654f, 0.667f,               // v4,v7,v6,v5 (back)
    };
    //커서 위치만을 두고 좌표를 어림잡아 찾았기 때문에 정확히 맞아 떨어지지는 않을 수 있다.
    ...
    void initBuffers() {
        ...
        glBufferSubData(GL_ARRAY_BUFFER, vSize + cSize, tSize, quadTexCoords); // copy texs after cols
